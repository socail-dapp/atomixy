...
const Home: NextPage = () => {
  ...
  return (
    <Layout>
      <div className="bg-gray-700 h-full w-full min-h-screen p-6">
        {/* <Head>
        ...
        <div className="text-8xl text-white font-semibold">
          Atomixy - The next wiki flow, fully decentralised sources
        </div>
        <br />
        <br />
...
const List = (props) => {
  return (
    <Link
      ...
      // href={`/flow/${props?.frozenData === 'ipfs' ? props?.ipfsPath : props?.arweaveId}?key=${props.index}&storage=${props?.frozenData}`}
