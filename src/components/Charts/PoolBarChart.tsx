...
const PoolBarCharts = ({ data = [] /* see data tab */, elements = [] }) => {
  console.log(data.length, data, "datapassed");
  return (
    <ResponsiveBar
      data={data}
...
const mock_color = ["#03dac6", "#cf6679", "#ff0266", "#bb86fc"];
interface IPool {
  txHash: string;
  blockHash: any;
