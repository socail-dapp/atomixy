...
export default function ({ setStorage, currentStorage, isCreate }) {
        ...
        <>
          ...
          <div className="flex row gap-2 ">
            ...
            <button
              ...
              className="w-full text-white bg-green-700 rounded-md font-medium "
            >
              FUND
            </button>
          </div>
          <p className="text-xs my-2 text-red-900">
            *confirm will fail if fund lower than est price, fund transaction
            will take around 5-10secs, and check your metamask after button
            pressed
          </p>
        </>
      )}
